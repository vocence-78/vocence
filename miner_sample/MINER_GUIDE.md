...
- Shipping a model whose effective weights come from another miner with cosmetic perturbations applied (precision roundtrips, ε-noise, dtype conversion) to evade the tensor fingerprint.
